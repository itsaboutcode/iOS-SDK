...
//    NSData *jsonData = [NSJSONSerialization dataWithJSONObject:batch options:NSJSONWritingPrettyPrinted error:nil];
//    NSString *jsonBatch = [[NSString alloc] initWithData:jsonData encoding:NSUTF8StringEncoding];
